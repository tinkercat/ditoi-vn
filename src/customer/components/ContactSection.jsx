        ...
        <div className="contact-grid">
          <div>
            ...
            <div className="social-row" style={{ marginTop: 24 }}>
              ...
              {zaloLink && <a href={zaloLink} target="_blank" rel="noopener noreferrer" aria-label="Zalo" title="Zalo"><BrandIcon name="zalo" size={22} /></a>}
              {fbLink && <a href={fbLink} target="_blank" rel="noopener noreferrer" aria-label="Facebook" title="Facebook">f</a>}
              {messengerLink && <a href={messengerLink} target="_blank" rel="noopener noreferrer" aria-label="Messenger" title="Messenger"><BrandIcon name="messenger" size={22} /></a>}
            </div>
